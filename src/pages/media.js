      ...
      <div className="grid-row grid-gap">
        ...
        <div className="tablet:grid-col-12">
          <ul className="usa-card-group">
            ...
            <Article title="Georgia’s campaign donation tracking website isn’t working, won’t be fixed before November election" img="https://upload.wikimedia.org/wikipedia/en/thumb/a/a7/Atlanta_News_First_logo_2022.svg/1024px-Atlanta_News_First_logo_2022.svg.png?20221003015203" quote="Ramaswami has now used his skills to code an interface — similar to a Microsoft Excel sheet — where he can compile his own data to keep track of donations and make sure he’s in compliance with state regulations on campaign finance. He said getting the information from the website would often take hours longer than it should, when the site didn’t completely crash altogether." href="https://www.atlantanewsfirst.com/2024/06/19/georgias-campaign-donation-tracking-website-isnt-working-wont-be-fixed-before-november-election/" date="June 19, 2024" />
          </ul>
        </div>
      </div>
    </section>
