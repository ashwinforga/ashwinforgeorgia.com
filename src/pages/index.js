      ...
      <div className="grid-row grid-gap">
        ...
        <div className="tablet:grid-col-12">
          <ul className="usa-card-group">
            ...
            <Issue href="/issues#safety" img="🚓" title="Invest in Public Safety">Let's be smarter at keeping our communities safe by training police, passing commonsense gun laws, and focusing on consumer protection.</Issue>
            {/* TODO: opioids? */}
