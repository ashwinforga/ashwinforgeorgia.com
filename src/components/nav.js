...
export const NavMobile = ({ className }) => (
  <nav className={'nav-mobile hidden-desktop ' + (className || '')}>
    <a href="/">
      <img src={logo} />
    </a>
  ...
  <>
    ...
    <nav role="navigation" className="usa-nav">
      <div className="usa-nav__inner">
        ...
        {/* <div className="donate">
          <a
            className="usa-button usa-nav__link"
            target="_blank"
            href="https://secure.actblue.com/donate/ashwin-for-georgia?refcode=website-nav"
          >
            DONATE
          </a>
        </div> */}
